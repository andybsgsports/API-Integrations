...
def collect(client: NetSuiteClient, field: str, label: str) -> None:
    print(f"\n=== {label} ({field}) ===")
    codes: dict[str, int] = {}
    items_with_data = 0
...
def main() -> int:
    ...
    collect(client, "custitem_sanmar_qty_by_whse", "SanMar sandbox data")
    collect(client, "custitem_ss_qty_by_whse", "S&S sandbox data")
    return 0
